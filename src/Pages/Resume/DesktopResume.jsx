...
const DesktopResume = () => {
  ...
  return (
    <div className='hidden mt-12 w-full md:flex items-center'>
            <section className='flex-none text-white md:w-[16rem] lg:w-[20rem] md:pr-10 lg:pr-14'>
                <ul className='flex flex-col'>    
                    ...
                    <ResumeNavBar 
                        ...
                        text="Education"
                        style={resume === "education"? "active" : null}
                    ...
                    <ResumeNavBar 
                        ...
                        style={resume === "programming"? "active" : null}
                    ...
                    <ResumeNavBar 
                        ...
                        text="Projects"
                        style={resume === "project"? "active" : null}
                    ...
                    <ResumeNavBar 
                        ...
                        text="Interests"
                        style={resume === "interest"? "active" : null}
