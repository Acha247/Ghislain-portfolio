        ...
        <div className='py-2 px-8'>
            <div className='flex items-center justify-between'>
                <h2 className='flex items-center'>
                    ...
                    <h2 className='font-bold ml-2 text-lg'>Visionary Technology Company</h2>
                </h2>
                <span className='text-orange-700'>2022 - Present </span>
            </div>
            <div className='ml-6 '>
                <h5 className='py-2 font-semibold text-orange-700'>FULL STACK DEVELOPER</h5>
                <p className='mb-2'>Currently working as a MERN stack web and mobile developer and also a freelancer on Upwork</p>
                <ul>
        ...
        <div className='py-2 px-8'>
            <div className='flex items-center justify-between'>
                <h2 className='flex items-center'>
                    ...
                    <h2 className='font-bold ml-2 text-lg'>Capital Insider</h2>
                </h2>
                <span className='text-orange-700'>2020 - 2021</span>
            </div>
            <div className='ml-6 '>
                <h5 className='py-2 font-semibold text-orange-700'>FULL STACK DEVELOPER</h5>
                <p className='mb-2'>Worked as a Web developer</p>
                <ul>
                    <li className='flex items-start'>
                        <span>- </span>
                        <p className='pl-2'>
